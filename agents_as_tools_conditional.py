...
class AppContext(BaseModel):
    # "spanish_only", "french_spanish", "european"
...
async def main():
    ...
    choice = input("\nSelect option (1-3): ")
    preference_map = {"1": "spanish_only",
                      "2": "french_spanish", "3": "european"}
    ...
    print(
        f"The LLM will only see and can use these {len(available_tools)} tools\n")
